...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/gstar/client-remotes': { kind: 'none', reason: 'The GSTAR Client Remote assembly selects browser namespaces and registers nothing model-facing.' },
  'packages/gstar/data-source': { kind: 'none', reason: 'The GSTAR source registry exposes product configuration and registers nothing model-facing.' },
  'packages/gstar/data-source-storage': { kind: 'none', reason: 'The GSTAR source selection Provider persists product configuration and registers nothing model-facing.' },
  'packages/gstar/data-source-osm': { kind: 'none', reason: 'The OSM source plugin publishes Host product data and registers nothing model-facing.' },
  'packages/gstar/data-source-reference': { kind: 'none', reason: 'The authoritative reference plugin publishes product metadata and registers nothing model-facing.' },
  'packages/gstar/data-source-akshare': { kind: 'none', reason: 'The AKShare source plugin enriches Host product data and registers nothing model-facing.' },
  'packages/gstar/site': { kind: 'none', reason: 'The station domain exposes Workspace-backed operations to product consumers and registers nothing model-facing.' },
  'packages/gstar/site-workspace': { kind: 'none', reason: 'The Workspace provider publishes station snapshots and registers nothing model-facing.' },
  'packages/gstar/spatial': { kind: 'none', reason: 'The spatial domain publishes station data snapshots and registers nothing model-facing.' },
  'packages/gstar/spatial-storage': { kind: 'none', reason: 'The spatial storage Provider persists product snapshots and registers nothing model-facing.' },
  'packages/gstar/cesium-assets': { kind: 'none', reason: 'The Cesium static-asset Host route registers nothing model-facing.' },
  ...
  'packages/client/ui-gstar': { kind: 'none', reason: 'Browser-side GSTAR product surface; registers nothing model-facing.' },
  ...
  'packages/bundle/gstar-app': { kind: 'none', reason: 'The bundle changes GSTAR Host/Client composition without registering model-visible content of its own.' },
