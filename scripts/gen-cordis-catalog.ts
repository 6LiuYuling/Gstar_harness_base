...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  fs: 'filesystem.md',
  goals: 'goal.md',
  gstarDataSources: 'gstar.md',
  gstarSites: 'gstar.md',
  gstarSpatial: 'gstar.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  GoalRef: 'goal.md',
  GoalView: 'goal.md',
  GstarAoiCategory: 'gstar.md',
  GstarAoiGeometry: 'gstar.md',
  GstarAoiSnapshot: 'gstar.md',
  GstarCoordinate: 'gstar.md',
  GstarDataSourceAccessMode: 'gstar.md',
  GstarDataSourceCapability: 'gstar.md',
  GstarDataSourceId: 'gstar.md',
  GstarDataSourceListRequest: 'gstar.md',
  GstarDataSourceProvider: 'gstar.md',
  GstarDataSourceSetEnabledRequest: 'gstar.md',
  GstarDataSourceSnapshot: 'gstar.md',
  GstarDataSourceSynchronizationSnapshot: 'gstar.md',
  GstarDataSourceSynchronizeRequest: 'gstar.md',
  GstarEntityFieldValue: 'gstar.md',
  GstarEntitySnapshot: 'gstar.md',
  GstarLinearRing: 'gstar.md',
  GstarMultiPolygonGeometry: 'gstar.md',
  GstarPolygonGeometry: 'gstar.md',
  GstarProvenanceSnapshot: 'gstar.md',
  GstarSiteCreateRequest: 'gstar.md',
  GstarSiteDeleteRequest: 'gstar.md',
  GstarSiteDeletionParticipant: 'gstar.md',
  GstarSiteDeletionPreparation: 'gstar.md',
  GstarSiteSnapshot: 'gstar.md',
  GstarSpatialLocateRequest: 'gstar.md',
  GstarSpatialPatchRequest: 'gstar.md',
  GstarSpatialRefreshAoisRequest: 'gstar.md',
  GstarSpatialSnapshot: 'gstar.md',
